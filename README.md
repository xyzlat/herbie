...
* Herbe uses _Kafka_ to provide _event streams_ — your services can subscribe to these event streams and find out when a certain entity-type is updated.
